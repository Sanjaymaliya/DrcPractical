...
import com.e.drc.extensions.dismissDialog
import com.e.drc.extensions.getProgressDialog
...
class  ApiRequest<T>(private val activity: Activity, objectType: T, private val TYPE: Int,
    ...
    override fun onResponse(call: Call<T>, response: Response<T>) {
        ...
        Log.e("Request URL123===> ", call.request().url().toString() + " Code " + response.code() + response.message())
